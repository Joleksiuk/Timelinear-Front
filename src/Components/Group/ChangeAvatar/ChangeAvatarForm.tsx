...
import { AvatarImageStyled, ChangeAvatarContainerStyled } from './ChangeAvatar.styled'
...
export default function ChangeAvatarForm({ setLoggedUser }: Props) {
    ...
    const [avatarType, setAvatarType] = useState<DiceBearAvatarCategory>('identicon')
    ...
    return (
        <ChangeAvatarContainerStyled>
            ...
            <AvatarImageStyled src={AvatarUtils.getAvatarUrl(avatarSeed, avatarType)} />
